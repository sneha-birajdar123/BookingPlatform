...
// router.post("/beautician/signup", async(req, res) => {
//     try {
...
// router.get("/beautician/emailverify/:token", async (req, res) => {
//     try {
//         const  token  = req.params.token
...
// router.get("/beautician/phoneverify/:token", async (req, res) => {
//     try {
...
// router.post("/beautician/signin", async (req, res) => {
//     try {
//         const { email, password } = req.body
